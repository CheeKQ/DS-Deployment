...
if workers < 5:
    notes.append("Very low worker count may reduce production capacity.")
if wip > 15000:
    notes.append("High WIP may increase congestion and slow down workflow.")
if overtime > 1.5:
